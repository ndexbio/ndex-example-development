...
#The only thing needed to be replaced is the inputxml.xml file
xml_filename = "15020_created_graphml.graphml"
xsl_filename_graph = "translatorGraph.xsl"
xsl_filename_key = "translatorKeys.xsl"


def graphml_to_cx(xml_filename, xsl_filename_graph, xsl_filename_key):
...
graphml_to_cx(xml_filename, xsl_filename_graph, xsl_filename_key)
